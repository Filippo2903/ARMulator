...
Cette interface diffère selon le mode actuel. Dans le mode \emph{édition} (figure~\ref{f:controles1}), seul le bouton \textit{Start} est actif. Dans le mode \emph{exécution}, que l'on peut accéder en pressant sur \textit{Start}, tous les boutons sont actifs, et le bouton \textit{Start} devient \textit{Stop}. 
\begin{figure}[h!]
\raggedleft
